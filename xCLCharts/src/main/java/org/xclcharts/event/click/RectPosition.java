...
//		}
		...
		float top = mRectFRange.top - 200;
		float right = mRectFRange.right + 5;
		float left = mRectFRange.left - 5;
		float bottom = mRectFRange.bottom + 200;
		...
		System.out.println ("compareRange返回为true");
		return true;
	}	
